...
export class DatosService {
  ...
  public readonly columnasDAAC: Campos[] = [
    ...
    { key: 'recibe', label: 'Quién recibe el resultado', Tooltip: 'Persona o grupo que recibe el resultado.', required: true, soloTexto: true },
    { key: 'requisitos', label: 'Requisitos legales', Tooltip: 'Normas o actos administrativos que lo sustentan.', required: true, soloTexto: true },
    { key: 'documentos', label: 'Documentos que se deben utilizar', Tooltip: 'Documentos de soporte del procedimiento.', required: true, soloTexto: true },
    { key: 'registros', label: 'Registros que se deben generar', Tooltip: 'Registros o evidencias generadas.', required: true, soloTexto: true },
